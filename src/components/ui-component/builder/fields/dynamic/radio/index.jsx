...
import { FormControl, FormHelperText, Radio, RadioGroup, Stack, Typography } from "@mui/material";
...
function DynamicFieldRadio(props) {
                ...
                {options.map((item, index) => {
                  return (
                    <FormControlLabel
                      ...
                      value={index}
                      control={<Radio disabled={disabled} checked={values?.[id]?.[item.value] ?? false} size="small" />}
