...
import { getFinancialFormBuilder } from "utils/apis/dashboards/user/userApis";
...
function JobForm({ setActiveStep }) {
  const { isLoading, data, isError, refetch } = useQuery(["getFinancialFormBuilder"], getFinancialFormBuilder);
