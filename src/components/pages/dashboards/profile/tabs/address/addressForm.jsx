...
import { APIEAddress } from "utils/apis/dashboards/user/userApis";
...
function AddressForm({ setActiveStep }) {
  const { isLoading, data, isError, refetch } = useQuery(["APIEAddress.formBuilder"], APIEAddress.formBuilder);
